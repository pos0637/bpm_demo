        ...
        return (
            <Dialog onClick={() => this.setState({ showDialog1: false })}>
                <Container left={1039} top={377} background={require("./images/box2.png")}>
                    ...
                    <LineChart left={1230} top={786} width={1193} height={356} color="rgba(68,175,244,0.8)" />
                    ...
                    <LineChart left={1230} top={1410} width={1193} height={356} color="rgba(68,175,244,0.8)" />
                </Container>
            </Dialog>
        );
    }
        ...
        return (
            <Dialog onClick={() => this.setState({ showDialog3: false })}>
                <Container left={1039} top={694} background={require("./images/box3.png")}>
                    ...
                    <LineChart left={1202} top={1103} width={1417} height={422} color="rgba(68,175,244,0.8)" />
                </Container>
            </Dialog>
        );
    }
